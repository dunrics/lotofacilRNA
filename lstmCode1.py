...
def execute_prediction():
    ...
    df = pd.read_csv("CAMINHO DO ARQUIVO\input_Resultados_Completo_cresc.csv")
    ...
    try:
        dados_antigos = pd.read_csv('CAMINHO DO ARQUIVO\outputRNA.csv')
    ...
    dados.to_csv('CAMINHO DO ARQUIVO\outputRNA.csv', index=False)
